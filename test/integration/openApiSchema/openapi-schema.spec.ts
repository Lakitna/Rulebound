    ...
    describe('Input type validation', function () {
        it('fails when schema = undefined', async function () {
            await expect(this.book.enforce(this.rule.name, {})).to.be.rejectedWith(
                'Expected schema to be an object'
            );
        });
        ...
        it('fails when json = undefined', async function () {
            await expect(this.book.enforce(this.rule.name, undefined, {})).to.be.rejectedWith(
                'Expected json to be an object'
            );
        });
